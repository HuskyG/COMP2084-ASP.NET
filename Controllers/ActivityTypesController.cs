...
namespace Chravel.Controllers
{
    public class ActivityTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ActivityTypeId,TypeName")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ActivityTypeId,TypeName")] ActivityType activityType)
        {
